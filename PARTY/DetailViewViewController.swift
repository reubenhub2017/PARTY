...
class DetailViewViewController:UIViewController  {
    ...
    @IBAction func addedpartier(sender: AnyObject) {
        ...
        self.numberofpeople.text = "\(addeding)"
    ...
    @IBOutlet weak var locationoftheparty: UILabel!
    ...
    override func viewDidLoad() {
        ...
        print(party!)
        print(party!.objectForKey("title"))
        numberofpeople.text = "\(party!.objectForKey("attending")!)"
        print(party!.createdAt!)
        ...
        _ = party!.objectForKey("location") as! PFGeoPoint
